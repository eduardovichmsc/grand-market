			...
			<section className="py-28 space-y-36">
				<div className="container">
					...
					<div className="inner flex gap-20 h-[890px]">
						<div className="basis-1/2 h-full bg-black/10 rounded-2xl shadow-md"></div>
						<div className="basis-1/2 h-full flex flex-col gap-[inherit]">
							<div className="basis-1/2 h-1/2 bg-black/10 rounded-2xl shadow-md"></div>
				...
				<div className="container h-[90vh] flex flex-col">
					...
					<div className="flex h-full gap-10 mt-10">
						<div className="basis-1/2 flex flex-col gap-[inherit]">
							...
							<div className="w-full h-1/2 flex gap-[inherit]">
				...
				<div className="container h-[56vh]">
					...
					<div className="flex h-full font-medium text-xl gap-14">
						<div className="rounded-2xl bg-res-green basis-1/3 h-full flex flex-col justify-center p-10 gap-14">
							{[1, 2, 3].map((index) => (
							...
							<div className="w-full h-[2px] bg-res-grey"></div>
						...
						<div className="basis-2/3 flex flex-col gap-5">
							<div className="w-full h-4/5 rounded-2xl bg-black/10 shadow-md"></div>
							<div className="w-full h-1/5 flex flex-col gap-[inherit]">
								<p className="">Все локаций : (3)</p>
								<div className="w-full h-[3px] bg-res-green"></div>
